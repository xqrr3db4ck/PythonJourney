...
df.to_excel('PedidosBMG1a1.xlsx', index=False)
df = pd.read_excel('PedidosBMG1a1.xlsx')
df.to_csv('BuscadorDePedidos.csv', index=False)
df = pd.read_csv('BuscadorDePedidos.csv', usecols=[2, 12])
print(df)
